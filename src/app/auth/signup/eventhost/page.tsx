        ...
        {signupSuccess ? (
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-secondary hover:bg-secondary/90 disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-3 px-4 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              {isLoading ? (
